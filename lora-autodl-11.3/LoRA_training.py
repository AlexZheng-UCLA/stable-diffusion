...
# directory 
dir_name = "chenweiting-50-DA-hassan"
project_name = "chenweiting-50-DA-hassan"
data_name = "chenweiting/chenweiting-512"

# model
training_ckpt = "/root/autodl-tmp/Stable-diffusion/chilloutmix_NiPrunedFp32Fix.safetensors"

vae = "/root/autodl-tmp/Stable-diffusion/vae-ft-mse-840000-ema-pruned.ckpt"  
